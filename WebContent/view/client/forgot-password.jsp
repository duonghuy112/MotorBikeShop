...
<title>Tromic - Forgot Password</title>
					...
					<div class="row h-100">
						<div class="col-lg-12">
							<div class="breadcrumb-item text-night-rider">
								<h2 class="breadcrumb-heading">Forgot Password Page</h2>
								<ul>
							...
							<div class="col-lg-6" style="float: none; margin: auto;">
								<form action="ForgotPassword" method="POST">
									<div class="login-form">
										...
										<div class="row">
											<div class="col-lg-12">
												<c:forTokens items="${confirmErr}-${userErr}" delims="-" var="e">
											...
											<div class="col-lg-12">
												<label>Confirm Email*</label> <input type="email"
													placeholder="Confirm Email" name="confirmEmail">
											</div>
											<div class="col-lg-12 pt-5">
												<button class="btn btn-custom-size lg-size btn-primary">Confirm</button>
											</div>
										</div>
									</div>
								</form>
