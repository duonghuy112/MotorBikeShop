								...
								<form action="Register" method="POST">
									<div class="login-form">
										...
										<div class="row">
											<div class="col-md-12">
												<c:forTokens
													items="${passwordErr}-${usernameErr}-${confirmPasswordErr}-${emailExistErr}-${usernameExistErr}-${systemErr}"
													delims="-" var="err">
													<label style="color: red; font-size: 16px">${err}</label>
												</c:forTokens>
												<label></label> <label>FullName*</label> <input type="text"
											...
											<div class="col-md-6">
												<label>Password*</label> <input type="password"
													placeholder="More than 6 characters" name="password"
													value="${password}">
											</div>
											<div class="col-md-6">
